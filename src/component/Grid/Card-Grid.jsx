...
function GridCards({
    ...
    useEffect(() => {
        if (sectionRef.current) {
            const cardElements = sectionRef.current.querySelectorAll(".card");
    ...
    return (
        <section
            ref={sectionRef}
            className="flex overflow-hidden flex-col px-16 py-28 w-full -mt-40 bg-gray-100 max-md:px-5 max-md:py-24 max-md:max-w-full"
